...
describe("distillThread", () => {
  ...
  const sampleMessages: ThreadMessage[] = [
    {
      author: "Alice",
      content: "How do I set up CopilotKit with Next.js?",
      timestamp: "2024-01-15 10:00",
    },
    {
      author: "Bob",
      content:
        "You need to install @copilotkit/react-core and wrap your app with CopilotKit provider.",
              ...
              pairs: [
                {
                  ...
                  answer:
                    "Install @copilotkit/react-core and wrap your app with the CopilotKit provider component.",
                  confidence: 0.92,
                },
              ],
            }),
  ...
  it("re-throws API errors (not JSON parse errors)", async () => {
    ...
    await expect(
      distillThread(sampleMessages, { apiKey: "test-key" }),
  ...
  it("uses specified model", async () => {
    ...
    await distillThread(sampleMessages, {
      apiKey: "test-key",
      model: "gpt-4o",
    });
