...
const files: Record<string, string> = {
  ...
  "/docs/guides/generative-ui.mdx":
    "# Generative UI\n\nBuild dynamic interfaces.",
  "/code/src/hooks/useCoAgent.ts":
    "export function useCoAgent() { return {}; }",
  "/code/src/hooks/useCopilotChat.ts":
    "export function useCopilotChat() { return {}; }",
  "/code/src/index.ts":
