...
describe("detectSourceType", () => {
  ...
  it('returns "markdown" when URLs end in .md', () => {
    const pages: CrawledPage[] = [
      {
        url: "https://raw.github.com/repo/docs/intro.md",
        html: "# Intro\nSome text",
        contentType: "text/plain",
        textLength: 100,
      },
      {
        url: "https://raw.github.com/repo/docs/guide.md",
        html: "# Guide\nMore text",
        contentType: "text/plain",
        textLength: 100,
      },
  ...
  it('defaults to "html" for mixed content', () => {
    const pages: CrawledPage[] = [
      ...
      {
        url: "https://docs.example.com/raw.md",
        html: "# Raw",
        contentType: "text/plain",
        textLength: 50,
      },
...
describe("detectContentSelector", () => {
  it("detects <main> element", () => {
    const html =
      "<html><body><nav>Nav</nav><main><h1>Content</h1><p>Text here</p></main></body></html>";
    expect(detectContentSelector(html)).toBe("main");
  });

  it("detects <article> element", () => {
    const html =
      "<html><body><article><h1>Post</h1><p>Body</p></article></body></html>";
...
describe("generateConfig", () => {
      ...
      pages: [
        {
          ...
          html: "<html><head><title>Intro - Example</title></head><body><main><h1>Intro</h1></main></body></html>",
          contentType: "text/html",
          textLength: 200,
        },
        {
          url: "https://docs.example.com/docs/guide",
          html: "<html><head><title>Guide - Example</title></head><body><main><h1>Guide</h1></main></body></html>",
          contentType: "text/html",
          textLength: 300,
        },
      ],
  ...
  it("derives server name from hostname", () => {
    const crawlResult: CrawlResult = {
      pages: [
        {
          url: "https://my-awesome-lib.readthedocs.io/en/latest/intro",
          html: "<html><body>Hi</body></html>",
          contentType: "text/html",
          textLength: 100,
        },
    ...
    const config = generateConfig(
      crawlResult,
      "https://my-awesome-lib.readthedocs.io",
    );
  ...
  it("detects git-hosted docs and uses repo source", () => {
    const crawlResult: CrawlResult = {
      pages: [
        {
          url: "https://github.com/org/repo/blob/main/docs/README.md",
          html: "# README",
          contentType: "text/plain",
          textLength: 100,
        },
...
describe("generateConfig edge cases", () => {
  ...
  it("detects GitLab repos correctly", () => {
    const crawlResult: CrawlResult = {
      pages: [
        {
          url: "https://gitlab.com/org/repo/-/blob/main/docs/README.md",
          html: "# README",
          contentType: "text/plain",
          textLength: 100,
        },
